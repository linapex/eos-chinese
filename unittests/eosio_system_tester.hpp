...
return stake.get_amount() * pow(2, int64_t((now - (config::block_timestamp_epoch / 1000)) / (86400 * 7))/ double(52) ); //52周（即~年）
   }
...
//创建账户defproducera、defproducerb，…、defproducerz并注册为生产商
