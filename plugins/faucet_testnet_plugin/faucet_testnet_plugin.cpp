...
//假设13个字符，如果强制使用13个字符搜索，这意味着效率低下，因为只有1到j是有效的。
      static const uint32_t max_allowed_name_length = 13;

   private:
//注意：编写的代码要求结构名称使用的charmap为“.12345abcdefghijklmnopqrstuvwxyz”
...
//默认为private testnet genesis.json中init帐户的公钥/私钥
